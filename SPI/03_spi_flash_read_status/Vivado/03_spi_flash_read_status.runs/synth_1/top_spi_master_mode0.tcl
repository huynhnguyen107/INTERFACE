...
synth_design -top top_spi_master_mode0 -part xck26-sfvc784-2LV-c
...
write_checkpoint -force -noxdef top_spi_master_mode0.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file top_spi_master_mode0_utilization_synth.rpt -pb top_spi_master_mode0_utilization_synth.pb"
