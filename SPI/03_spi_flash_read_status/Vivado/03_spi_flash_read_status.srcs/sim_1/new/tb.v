...
module tb();
	...
	integer i=0;
	//call instance 
	spi_master_mode0 #(50000000) spi_master_mode0(clk, rest_n, start, byte_transfer, data_in, done, busy, data_out, spi_clk, spi_mosi, spi_cs_n, spi_miso);
