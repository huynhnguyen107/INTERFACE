...
HD_PWD='d:/FPGA/Vivaldo Project/INTERFACE/SPI/02_spi_flash_read_jedec_id/Vivado/02_spi_flash_read_jedec_id.runs/impl_1/.Xil/Vivado-7888-LAPTOP-CHCSI1R5/dc_drv.0/dc/prj_ip.runs/dbg_hub_synth_1'
cd "$HD_PWD"
