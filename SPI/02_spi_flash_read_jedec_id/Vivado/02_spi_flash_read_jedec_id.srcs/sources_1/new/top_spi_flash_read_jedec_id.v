...
// 
// Create Date: 08/03/2026 11:39:15 AM
// Design Name: top_spi_flash_read_jedec_id
// Module Name: top_spi_flash_read_jedec_id
...
module top_spi_flash_read_jedec_id(
	input clk_25mhz,
	input rst_n,
	input start,
	//SPI interface
	...
	spi_flash_read_jedec_id #(50000000,4) spi_flash_read_jedec_id(clk_100mhz, rst_n, start, data_in, done, busy, data_out, spi_clk, spi_mosi, spi_cs_n, spi_miso);
	//out leds
	...
	.probe8(data_in), // input wire [31:0]  probe8 
	.probe9(data_out) // input wire [31:0]  probe9
);
